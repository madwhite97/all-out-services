            ...
            className="relative flex min-h-screen items-start overflow-hidden pt-32 md:items-center md:pt-0">
                ...
                <div className="relative z-10 mx-auto w-full max-w-7xl px-6">
                    ...
                    >
                        ...
                        <div className="mt-16 flex flex-col items-center gap-4 text-center text-sm font-medium uppercase tracking-wider text-gray-300 sm:flex-row sm:flex-wrap sm:justify-center sm:gap-8">
                ...
                <div className="absolute bottom-10 left-1/2 hidden -translate-x-1/2 animate-bounce text-white md:block">
                    <a 
                        href="#services"
